...
lecture = csv.DictReader(open('6741_Lectures.csv'))
slide_topic_g = Graph()
...
slide_topic_g.serialize(destination='6741slide_topic_graph.ttl', format='turtle')
...
worksheet_topic_g.serialize(destination='6741worksheet_topic_graph.ttl', format='turtle')
...
lab_topic_g.serialize(destination='6741lab_topic_graph.ttl', format='turtle')
...
reading_topic_g.serialize(destination='6741reading_topic_graph.ttl', format='turtle')
...
material_topic_g.serialize(destination='6741material_topic_graph.ttl', format='turtle')               
...
new_g.parse('lecture_graph.ttl', format='turtle')
slide_topic.parse('6741slide_topic_graph.ttl', format='ttl')
worksheet_topic.parse('6741worksheet_topic_graph.ttl', format='ttl')
material_topic.parse('6741material_topic_graph.ttl', format='ttl')
reading_topic.parse('6741reading_topic_graph.ttl', format='ttl')
lab_topic.parse('6741lab_topic_graph.ttl', format='ttl')

new_g += slide_topic + worksheet_topic + material_topic + reading_topic + lab_topic

new_g.serialize(destination='6741withTopic_graph.ttl', format='ttl')
